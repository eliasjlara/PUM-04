...
bool lidar_data__msg__lidar_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lidar_data.msg._lidar_data.LidarData", full_classname_dest, 36) == 0);
  }
  lidar_data__msg__LidarData * ros_message = _ros_message;
  {  // header
...
PyObject * lidar_data__msg__lidar_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("lidar_data.msg._lidar_data");
