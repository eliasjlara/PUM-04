...
bool audio_data__msg__audio_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("audio_data.msg._audio_data.AudioData", full_classname_dest, 36) == 0);
  }
  audio_data__msg__AudioData * ros_message = _ros_message;
  {  // header
  ...
  {  // channels
    ...
    assert(PyLong_Check(field));
    ros_message->channels = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // samples
    ...
    assert(PyLong_Check(field));
    ros_message->samples = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of AudioData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("audio_data.msg._audio_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AudioData");
  ...
  {  // channels
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->channels);
    {
  ...
  {  // samples
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->samples);
    {
