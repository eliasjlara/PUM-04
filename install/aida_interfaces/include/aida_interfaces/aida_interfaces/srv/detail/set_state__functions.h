...
#ifndef AIDA_INTERFACES__SRV__DETAIL__SET_STATE__FUNCTIONS_H_
#define AIDA_INTERFACES__SRV__DETAIL__SET_STATE__FUNCTIONS_H_
...
/// Initialize srv/SetState message.
/**
...
/// Create srv/SetState message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * aida_interfaces__srv__SetState_Request__init().
...
/// Destroy srv/SetState message.
/**
 * It calls
 * aida_interfaces__srv__SetState_Request__fini()
...
/// Check for srv/SetState message equality.
/**
...
/// Initialize array of srv/SetState messages.
/**
...
/// Finalize array of srv/SetState messages.
/**
 * It calls
 * aida_interfaces__srv__SetState_Request__fini()
...
/// Create array of srv/SetState messages.
/**
 * It allocates the memory for the array and calls
 * aida_interfaces__srv__SetState_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetState messages.
/**
 * It calls
 * aida_interfaces__srv__SetState_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetState message array equality.
/**
...
/// Copy an array of srv/SetState messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * aida_interfaces__srv__SetState_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aida_interfaces
...
/**
 * It calls
 * aida_interfaces__srv__SetState_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_aida_interfaces
...
/**
 * It allocates the memory for the array and calls
 * aida_interfaces__srv__SetState_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aida_interfaces
...
/**
 * It calls
 * aida_interfaces__srv__SetState_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AIDA_INTERFACES__SRV__DETAIL__SET_STATE__FUNCTIONS_H_
