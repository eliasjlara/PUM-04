...
{
  new (message_memory) aida_interfaces::msg::Joystick(_init);
}

void Joystick_fini_function(void * message_memory)
{
  auto typed_message = static_cast<aida_interfaces::msg::Joystick *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Joystick_message_member_array[3] = {
  {
    ...
    offsetof(aida_interfaces::msg::Joystick, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aida_interfaces::msg::Joystick, x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aida_interfaces::msg::Joystick, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Joystick_message_members = {
  "aida_interfaces::msg",  // message namespace
  "Joystick",  // message name
  3,  // number of fields
  sizeof(aida_interfaces::msg::Joystick),
...
get_message_type_support_handle<aida_interfaces::msg::Joystick>()
{
  return &::aida_interfaces::msg::rosidl_typesupport_introspection_cpp::Joystick_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aida_interfaces, msg, Joystick)() {
  return &::aida_interfaces::msg::rosidl_typesupport_introspection_cpp::Joystick_message_type_support_handle;
}
